      ...
      <div className="post_wrapper py-25 px-20">
        <div className="grid grid-cols-3 gap-2">
          {posts.map((data, key) => (
			...
			<div><NavLink
                  to={`/${data._id}`}
                  className="inline-block w-full px-3 py-2 mt-4 font-semibold text-center text-white transition-colors duration-200 transform bg-green-500 rounded-md hover:bg-blue-400"
                >
                  Read More
                </NavLink></div>
        ...
        <section className="mb-25 text-gray-800 text-center">
          ...
          <div className="grid gap-x-3 grid-cols-3">
            <div className="mb-12">
              ...
              <h3 className="text-2xl font-bold text-blue-600 mb-4">{posts.length}</h3>
              <h5 className="text-lg font-medium text-gray-500">Campaigns</h5>
            </div>

            <div className="mb-12">
              
              <h3 className="text-2xl font-bold text-blue-600 mb-4">65%</h3>
              <h5 className="text-lg font-medium text-gray-500">Growth</h5>
            </div>

            <div className="mb-12">
              
              <h3 className="text-2xl font-bold text-blue-600 mb-4">800000000</h3>
