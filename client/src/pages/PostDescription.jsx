...
const PostDescription = () => {
	...
	return post ? (
		<div className="text-gray-600 body-font">
			<div className=" flex justify-between max-w-screen-xl px-4 py-6 mx-auto my-5 border-2">
				...
				<div className="w-4/12">
					<div className="flex flex-col mt-20 ">
						<input
							...
							className="rounded w-full py-6 px-3 text-gray-700 leading-tight focus:outline-none bg-gray-50 text-sm mb-2"
					...
					<div className="flex flex-col items-center my-2 ">
						...
						<p className="text-xl mt-2 mx-3">
							{" "}
							Pleged:
							<span className="text-xl font-semibold ">{post.amount}$</span>
						</p>
						<p className="pt-6">
							Created At: {Moment(post.createdAt).format("YYYY/MM/DD")}
						</p>
					</div>
				</div>
			</div>
			...
			<div className="bg-white py-6">
				<div className="max-w-screen-xl px-4 py-6 mx-auto border-2">
					...
					<div className="bg-white p-5 modal__content rounded">
						...
						<div className="modal__footer mt-6">
							<div className="text-right">
								...
								<button className="border-2 border-purple p-3  text-center text-white transition-colors duration-200 transform bg-[#38bdf8] rounded-md">
									Submit Comment
								</button>
							</div>
						</div>
